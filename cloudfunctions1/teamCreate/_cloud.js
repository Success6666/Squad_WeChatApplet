// Compatibility loader (copied)
let cloud
let loadedFrom = null
try { cloud = require('wx-server-sdk'); loadedFrom='wx-server-sdk' } catch (e) { try { cloud=require('tcb-admin-node'); loadedFrom='tcb-admin-node' } catch (e2) { const msg=`Neither wx-server-sdk nor tcb-admin-node could be required. ${e.message}; ${e2.message}`; const err=new Error(msg); err.primary=e; err.fallback=e2; throw err } }
